            ...
            if (i <= cantidadViandas) {
                switch (tipoVianda) {
                    ...
                    case 4:
                        ...
                        totalProductos += 1
                        console.log(`Valor de vianda numero ${i} es: $` + precioViandaCuatro)
                        break;
                    case 5:
                        totalPrecio += precioViandaCinco
                        totalProductos += 1
                        console.log(`Valor de vianda numero ${i} es: $` + precioViandaCinco)
                        break;
                    case 6:
...
function cierreVenta () {
    ...
    if (ventaFinal !=""){
        switch (ventaFinal){
            ...
            case "Si":
            case "si":
                alert("Perfecto! Nos estaremos contactando contigo para coordinar la entrega y el pago\nGracias por comprar en Bon AppetEat!")
                console.log("Perfecto! Nos estaremos contactando contigo para coordinar la entrega y el pago\nGracias por comprar en Bon AppetEat!")
                break;
            case "NO":
            case "No":
            case "no":
